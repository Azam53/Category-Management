                   ...
                   @if($category->name != 'Parent')
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne{{$category->id}}">{{$category->name}}</a><a href="categorydelete/{{$category->id}}"><span class="glyphicon glyphicon-trash pull-right"></span></a>
                        </h4>
                    </div>
                   @endif
                   @if(!empty($category_child))
                     @foreach($category_child as $category2)
                    <div id="collapseOne{{$category->id}}" class="panel-collapse collapse in">
